...
An example of a configuration file for using the MQTT protocol is delivered at
`/usr/share/doc/yggdrasil/example_mqtt_config.toml`, which can be modified as
needed and copied to `/etc/yggdrasil/config.toml`.
